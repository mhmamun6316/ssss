            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title text-center">All Nurse
                        <button type="button" class="btn btn-success btn-sm float-end" data-bs-toggle="modal" data-bs-target="#AddEmployeeModal">ADD Nurse</button>
                    </h4>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.editBtn', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/nurse/edit-nurse/" + patient_id,
